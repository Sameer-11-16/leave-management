    ...
    <div className="auth-page">
      <div className="auth-aside">
        <div className="auth-aside-content">
          <h1 className="auth-aside-title">Streamline Your Work Life</h1>
          <p className="auth-aside-text">The most intuitive way to manage your leave requests and team availability. Experience a seamless workflow designed for modern teams.</p>
        </div>
      </div>
      ...
      <div className="auth-form-side">
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form-vertical anim-fadeInUp">
            ...
            <button className="btn btn-primary btn-full btn-lg" type="submit" disabled={loading} style={{ height: '52px' }}>
              {loading ? (
